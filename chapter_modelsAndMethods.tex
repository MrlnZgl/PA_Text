    ...
    \begin{table}[H]
        ...
        \begin{minipage}[T!]{1.0\textwidth}
            ...
            \begin{minipage}[T!][5.3cm][T!]{0.43\textwidth}
                \includegraphics[width=1.0\textwidth]{Latex_Thesis_template/initalValueComb.pdf}
                \vfill{}
		        \caption*{(a) Arrangement of initial value combination of material parameters}
                \label{tab:amplitudemenu}
            \end{minipage}
            \hspace{0.05\textwidth} % Horizontal space between the minipage
            \begin{minipage}[T!][5.3cm][T!]{0.43\textwidth}
                \includegraphics[width=\textwidth]{Latex_Thesis_template/ModelCombinations.pdf}
                \vfill{}
     ...
     \begin{figure}[H]
        ...
        \begin{minipage}[T!]{1.0\textwidth}
            ...
            \begin{minipage}[T!][9cm][T!]{0.35\textwidth}
                \includegraphics[width=\textwidth]{Latex_Thesis_template/Amplitude.pdf}
                \vfill{}
            ...
            \begin{minipage}[T!][9cm][T!]{0.35\textwidth}
                \includegraphics[width=\textwidth]{Latex_Thesis_template/BC.pdf}
                \vfill{}
    ...
    \section{Optimisation process}
     ...
     \begin{table}[H]
		\centering
        \includegraphics[width=0.95\textwidth]{Latex_Thesis_template/minimizeFuncitonInput.pdf}
