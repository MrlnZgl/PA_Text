...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{verfiy_stress_strain_progress.pdf}
...
\end{figure}
   ...
   \begin{figure}[H]
    ...
    \begin{subfigure}[t]{1.0\textwidth}
        \centering
        \includegraphics[width=\textwidth]{valid4to3_material_params.pdf}
        \caption{Evolution of material 4:3}
        \label{fig:material_params_4to3}
    \end{subfigure}

    \vspace{1em} % kleiner Abstand zwischen den beiden Plots

    % (b)
    \begin{subfigure}[t]{1.0\textwidth}
        \centering
        \includegraphics[width=\textwidth]{valid8to3_material_paramspdf.pdf}
...
\end{figure}
    ...
    \begin{subfigure}[t]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{valid4to3_stress_strain_combined.pdf}
    ...
    \begin{subfigure}[t]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{valid4to3_rmse.pdf}
        \caption{RMSE evolution (4:3)}
        \label{fig:validation_rmse_4to3}
    \end{subfigure}

    \vspace{1em} % kleiner vertikaler Abstand zwischen den Reihen

    % --- untere Reihe: 8:3 ---
    \begin{subfigure}[t]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{valid8to3_stress_strain_combined.pdf}
    ...
    \begin{subfigure}[t]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth]{valid8to3_rmse.pdf}
