...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.7\textwidth]{Vald_6To3_Params3_rsme_lin_plot.pdf}
...
\begin{subfigure}[t]{0.495\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Vald_4To3_fixEP1_rsme_lin_plot.pdf}
...
\begin{subfigure}[t]{0.495\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Vald_8To3_fixEP1_rsme_lin_plot.pdf}
