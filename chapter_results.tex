    ...
    \begin{figure}[H]
        ...
        \subfigure[evolution of stress-strain curve]{
            ...
            \input{stress_strain_progress.pdf_tex}
            \label{fig:progress stress-strain curve}
        }
        \subfigure[final stress-strain curves]{
            \def\svgwidth{0.47\textwidth}
            \input{verify_stress_strain_combined.pdf_tex}
   ...
   \begin{figure}
    ...
    \begin{figure}[H]
		\centering
		\def\svgwidth{0.7\textwidth}
        \input{validate6to3_material_params.pdf_tex}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Final stress-strain curves]{
            \def\svgwidth{0.47\textwidth}
            \input{validate6to3_stress_strain_combined.pdf_tex}
    		\label{fig:validation stress-strain curves 6to3}
        }
        \subfigure[RMSE evolution]{
            \def\svgwidth{0.47\textwidth}
            \input{validate6to3_rsme.pdf_tex}
            \label{fig:validation rmse 6to3}
        }
    ...
    \begin{figure}[H]
        ...
        \subfigure[evolution of material 4:3]{
            ...
            \input{validate4to3_material_params.pdf_tex}
    		\label{fig:material params 4to3}
        }
        \subfigure[evolution of 8:4]{
            \def\svgwidth{0.8\textwidth}
            \input{validate8to3_material_params.pdf_tex}
    ...
    \begin{figure}[H]
        ...
        \subfigure[stress-strain curves]{
            ...
            \input{validate4to3_stress_strain_combined.pdf_tex}
    		\label{fig:validation stress-strain curves 4to3}
        }
        \subfigure[RMSE evolution]{
            \def\svgwidth{0.4\textwidth}
            \input{validate4to3_rmse.pdf_tex}
            \label{fig:validation rmse 4to3}
        }
        \subfigure[Final stress-strain curves]{
            \def\svgwidth{0.4\textwidth}
            \input{validate8to3_stress_strain_combined.pdf_tex}
    		\label{fig:validation stress-strain curves 8to3}
        }
        \subfigure[RMSE evolution]{
            \def\svgwidth{0.4\textwidth}
            \input{validate8to3_rmse.pdf_tex}
