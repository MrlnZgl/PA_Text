...
%\captionsetup[sub]{labelfont=bf,labelsep=period,labelformat=brace}
...
\usepackage[
    ...
    isbn = false,
	giveninits=true,
    defernumbers=true 	%First names as initials
]{biblatex}
...
% \DeclareCaptionLabelFormat{brace}{\alph{sub\@captype}}
% \makeatother
